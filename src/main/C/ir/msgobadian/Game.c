...
void difficultyMenu(int *difficulty, float *wave_time_span, float *time_span_decreasing_percentage);
...
void checkStoppingFreezeMode(float *wave_time_span, int *freeze);
...
int main() {
    ...
    difficultyMenu(&difficulty, &wave_time_span, &time_span_decreasing_percentage);
    ...
    for (n = 0; n < 1000; n++) {                            //new word coming from above
        ...
        checkStoppingFreezeMode(&wave_time_span, &freeze);
...
void difficultyMenu(int *difficulty, float *wave_time_span, float *time_span_decreasing_percentage) {
    ...
    while ((*difficulty) != 1 && (*difficulty) != 2 && (*difficulty) != 3 &&
           (*difficulty) != 4) {    //check if difficulty is entered correctly
        printf("Wrong Number");
        sleep(1);
        printf("\r             \r");
        scanf("%d", difficulty);
    ...
    switch ((*difficulty)) {
        case 1 : {
            (*wave_time_span) = 10;
            (*time_span_decreasing_percentage) = .8;
            break;
        }
        case 2 : {
            (*wave_time_span) = 8;
            (*time_span_decreasing_percentage) = .7;
            break;
        }
        case 3 : {
            (*wave_time_span) = 5;
            (*time_span_decreasing_percentage) = .6;
            break;
        }
        case 4 : {
