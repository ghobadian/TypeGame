...
int points=0;
int wave=0;
int permission_to_change_wave=0;	//global
//int move_up=0;
...
void words_from_file(FILE* words){		//reading 10 new words from the file
	for(int i=0;i<10;i++)
